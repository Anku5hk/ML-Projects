...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;There is a fair amount debate around "python is a slow language", but for most parts that does affects usability/credibility, it is the most prefered programming language and is still growing popular(as of 2021). 
### Some Terminology  
